package fr.exanpe.roomeeting.web.services.exceptionHandler;
 ...
 * @author jmaupoux
 */
public class RooMeetingRequestExceptionHandler implements RequestExceptionHandler
{
    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(RooMeetingRequestExceptionHandler.class);
     ...
     */
    public RooMeetingRequestExceptionHandler(ExceptionHandlerService exceptionService, ComponentSource componentSource, ResponseRenderer renderer,
