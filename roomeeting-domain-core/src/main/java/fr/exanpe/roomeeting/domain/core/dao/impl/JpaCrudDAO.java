 ...
 * 
 */
package fr.exanpe.roomeeting.domain.core.dao.impl;
...
public class JpaCrudDAO implements CrudDAO
{
    ...
    @Override
    public <T> List<T> findCriteriaQuery(CriteriaQuery<T> query)
    {
        return entityManager.createQuery(query).getResultList();
    }

    @Override
    public <T> List<T> findCriteriaQuery(CriteriaQuery<T> query, int range)
    {
        return entityManager.createQuery(query).setMaxResults(range).getResultList();
    }
