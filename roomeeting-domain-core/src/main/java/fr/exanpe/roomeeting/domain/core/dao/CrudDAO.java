package fr.exanpe.roomeeting.domain.core.dao;
...
public interface CrudDAO
{
    ...
    <T> List<T> findCriteriaQuery(CriteriaQuery<T> query);

    <T> List<T> findCriteriaQuery(CriteriaQuery<T> query, int range);
